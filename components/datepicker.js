// this is a very slightly modified version of react-native-datepicker 
...
class DatePicker extends Component {
  ...
  componentDidUpdate(prevState) {
    if (prevState.date !== this.props.date) {
      return({date: this.getDate(this.props.date)});
    }
  }
          ...
          {/* {
            !this.props.hideText ?
              <View style={dateInputStyle}>
                ...
                <Text style={styles.pickerRowItem}>Pick New Date</Text>
              </View>
            :
              <View/>
          } */}

          <Text style={[styles.pickerRowItem,styles.pickerRowButton]}>New</Text>
